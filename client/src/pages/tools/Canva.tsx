  ...
  return (
    <ToolDetail
      ...
      features={[
        ...
        "Genuine team seat — added to your own Canva account",
      ...
      plans={[
        {
          ...
          type: "Team",
          specs: [
            { label: "Access", value: "Genuine team invite" },
